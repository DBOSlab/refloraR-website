...
## Os Desenvolvedores do `refloraR`
...
<div class="authors-group">
  ...
  <div class="author-card">
    ...
    <div class="author-info">
      ...
      <p>Taxonomista e bioinformata líder do pacote refloraR, responsável pelo design e codificação das funções, bem como pelo desenvolvimento do site do projeto</p>
    </div>
  </div>

  <div class="author-card">
    <img src="/authors/images/carlos.jpg" alt="Carlos Calderón" class="author-photo" />
    <div class="author-info">
      ...
      <p>Bioinformata que contribui para o pacote refloraR, com foco no design e implementação dos fluxos de trabalho das funções</p>
    </div>
  </div>
...
<div class="authors-group">
  ...
  <div class="author-card">
    ...
    <div class="author-info">
      ...
      <p>Taxonomista sênior e coordenadora da iniciativa Reflora no Brasil</p>
    </div>
  </div>

  <div class="author-card">
    <img src="/authors/images/paula.jpg" alt="Paula Leitman" class="author-photo" />
    <div class="author-info">
      ...
      <p>Especialista em integração de dados de biodiversidade e membro da equipe Reflora</p>
    </div>
  </div>

  <div class="author-card">
    <img src="/authors/images/fabiana.jpg" alt="Fabiana Filardi" class="author-photo" />
    <div class="author-info">
  ...
  <div class="author-card">
    <img src="/authors/images/anaflavia.jpg" alt="Flávia Versiane" class="author-photo" />
    <div class="author-info">
      ...
      <p>Pesquisadora associada que contribui para a curadoria de dados do Reflora</p>
    </div>
  </div>
